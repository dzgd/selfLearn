...
def get_tag(_list, offset=1):
    ...
    if len(set(_new_list)) == 1:
        ...
        _return_data = [data[0:offset - 1] for data in _list]
...
if __name__ == '__main__':
    # url = "http://www.dianping.com/search/keyword/17/10_%E5%92%96%E5%95%A1/p1"
    url = 'http://www.dianping.com/shop/FAZvqbq6HX7J9Ae7'
    get_data(url)
    print("******over******")
